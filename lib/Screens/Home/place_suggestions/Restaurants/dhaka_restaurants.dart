...
class DhakaRestaurants extends StatefulWidget {
  final id;
  const DhakaRestaurants({Key? key,this.id}) : super(key: key);

  @override
  State<DhakaRestaurants> createState() => _DhakaRestaurantsState();
}

class _DhakaRestaurantsState extends State<DhakaRestaurants> {
        ...
        body: Column(
          children: [
            Expanded(child: StreamBuilder(
              stream: FirebaseFirestore.instance.collection('dhaka_restaurant').snapshots(),
