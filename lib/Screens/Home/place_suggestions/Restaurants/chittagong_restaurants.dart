...
class chittagongRestaurants extends StatefulWidget {
  final id;
  const chittagongRestaurants({Key? key,this.id}) : super(key: key);

  @override
  State<chittagongRestaurants> createState() => _chittagongRestaurantsState();
}

class _chittagongRestaurantsState extends State<chittagongRestaurants> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(title: Text('Restuarants'),backgroundColor: kPrimaryColor,),
        body: Column(
          children: [
            Expanded(child: StreamBuilder(
              stream: FirebaseFirestore.instance.collection('chittagong_restaurants').snapshots(),
