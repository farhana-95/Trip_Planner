...
import 'package:trip_planner/Screens/Home/place_suggestions/Resorts/dhaka_resorts.dart';
import 'package:trip_planner/Screens/Home/place_suggestions/Restaurants/dhaka_restaurants.dart';
...
class Dhaka extends StatefulWidget {
  ...
  @override
  State<Dhaka> createState() => _DhakaState();
}
...
class _DhakaState extends State<Dhaka> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Places in Dhaka'),backgroundColor: kPrimaryColor,),

      body: StreamBuilder(
        stream: FirebaseFirestore.instance.collection('dhaka').snapshots(),
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      GestureDetector(
                                          ...
                                          onTap: (){
                                            Navigator.of(context).push(MaterialPageRoute(
                                                builder: (context) => dhaka_resorts(id: documentSnapshot.id)));
                                      ...
                                      GestureDetector(
                                          ...
                                          onTap: (){
                                            Navigator.of(context).push(MaterialPageRoute(
                                                builder: (context) => DhakaRestaurants(id: documentSnapshot.id)));
