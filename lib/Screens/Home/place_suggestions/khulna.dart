...
import 'package:trip_planner/Screens/Home/place_suggestions/Resorts/khulna_resorts.dart';
import 'package:trip_planner/Screens/Home/place_suggestions/Restaurants/khulna_restaurants.dart';
...
class Khulna extends StatefulWidget {
  ...
  @override
  State<Khulna> createState() => _KhulnaState();
}
...
class _KhulnaState extends State<Khulna> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Places in Khulna'),backgroundColor: kPrimaryColor,),
      body: StreamBuilder(
        stream: FirebaseFirestore.instance.collection('khulna').snapshots(),
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      GestureDetector(
                                          ...
                                          onTap: (){
                                            Navigator.of(context).push(MaterialPageRoute(
                                                builder: (context) => khulna_resorts(id: documentSnapshot.id)));
                                      ...
                                      GestureDetector(
                                          ...
                                          onTap: (){
                                            Navigator.of(context).push(MaterialPageRoute(
                                                builder: (context) => khulnaRestaurants(id: documentSnapshot.id)));
