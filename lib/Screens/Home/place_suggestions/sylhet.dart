...
class Sylhet extends StatefulWidget {
  ...
  @override
  State<Sylhet> createState() => _SylhetState();
}
...
class _SylhetState extends State<Sylhet> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Places in Sylhet'),backgroundColor: kPrimaryColor,),

      body: StreamBuilder(
        stream: FirebaseFirestore.instance.collection('sylhet').snapshots(),
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      GestureDetector(
                                          ...
                                          onTap: (){
                                            Navigator.of(context).push(MaterialPageRoute(
                                                builder: (context) => sylhet_resorts(id: documentSnapshot.id)));
                                      ...
                                      GestureDetector(
                                          ...
                                          onTap: (){
                                            Navigator.of(context).push(MaterialPageRoute(
                                                builder: (context) => SylhetRestaurants(id: documentSnapshot.id)));
