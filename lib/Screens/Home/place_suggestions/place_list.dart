              ...
              Center(
                child: GestureDetector(
                  child: Container(
                    ...
                    child: Center(child: Text('Chittagong',style: TextStyle(color: Colors.white,fontSize: 20),)),
                  ),
                ...
                child: GestureDetector(
                  child: Container(
                    ...
                    decoration: const BoxDecoration(
                      ...
                      borderRadius: BorderRadius.all(Radius.circular(10)),
                    ),                    child: Center(child: Text('Dhaka',style: TextStyle(color: Colors.white,fontSize: 20),)),
                ...
                child: GestureDetector(
                  child: Container(
                    ...
                    decoration: const BoxDecoration(
                      ...
                      borderRadius: BorderRadius.all(Radius.circular(10)),
                    ),                    child: Center(child: Text('Khulna',style: TextStyle(color: Colors.white,fontSize: 20),)),
              ...
              Center(
                child: GestureDetector(
                  child: Container(
                    ...
                    child: Center(child: Text('Sylhet',style: TextStyle(color: Colors.white,fontSize: 20),)),
                ...
                child: GestureDetector(
                  child: Container(
                    ...
                    decoration: const BoxDecoration(
                      ...
                      borderRadius: BorderRadius.all(Radius.circular(10)),
                    ),                    child: Center(child: Text('Barisal',style: TextStyle(color: Colors.white,fontSize: 20),)),
                ...
                child: GestureDetector(
                  child: Container(
                    ...
                    decoration: const BoxDecoration(
                      ...
                      borderRadius: BorderRadius.all(Radius.circular(10)),
                    ),                    child: Center(child: Text('Rajshahi',style: TextStyle(color: Colors.white,fontSize: 20),)),
                ...
                child: GestureDetector(
                  child: Container(
                    ...
                    decoration: const BoxDecoration(
                      ...
                      borderRadius: BorderRadius.all(Radius.circular(10)),
                    ),                    child: Center(child: Text('Mymensingh',style: TextStyle(color: Colors.white,fontSize: 20),)),
