...
class _TripState extends State<Trip> {
  ...
  Future<void> _reminder([DocumentSnapshot? documentSnapshot]) async {
                              ...
                              ,
                                child: ClipRRect(
                                  ...
                                  child: CachedNetworkImage(
                                    ...
                                    errorWidget: (context, url, error) => const Icon(Icons.card_travel,color: kPrimaryColor,size: 38,),
                                  ),
                                  // Image.network(
                                  ...
                                  PopupMenuItem(
                                    ...
                                    child: Row(
                                      children: const [
                                        ...
                                        Icon(Icons.notifications_on_outlined, color: Colors.grey),
                                      ],
                                    ),
                                  ),
                                  PopupMenuItem(
                                      ...
                                      Navigator.of(context).push(
                                          MaterialPageRoute(
                                              builder: (context) => Expense(
                                                  tripid: documentSnapshot[
                                                      'tripid'],name: documentSnapshot['tripname'])));
                                      break;
                                    case 4:  _reminder(documentSnapshot); break;
                                    case 5:
                                      showDialog(
                                          context: context,
